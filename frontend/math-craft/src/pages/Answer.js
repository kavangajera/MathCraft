...
//       console.log('Fetched question and answers:', data);
...
//         console.log('All comments fetched:', newComments);
//       } else {
...
//       });
//       const data = await response.json();
//       console.log(`Fetched comments for answer ${answerId}:`, data);

//       if (response.ok) {
//         return data.comments || [];
//       } else {
//         console.error(`Failed to fetch comments for answer ${answerId}:`, data.message);
//         return [];
//       }
//     } catch (err) {
//       console.error(`Error fetching comments for answer ${answerId}:`, err);
//       return [];
//     }
//   };
...
//               {imageBase64 && <p className="file-name">Image selected</p>}
//             </div>
